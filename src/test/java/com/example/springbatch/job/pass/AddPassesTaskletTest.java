...
public class AddPassesTaskletTest {
    ...
    public void test_execute() throws Exception {
        //given
        final String userGroupId = "TESTGROUP";
        final String userId = "A123456";
        ...
        when(userGroupMappingRepository.findByUserGroupId(eq("TESTGROUP"))).thenReturn(List.of(userGroupMappingEntity));
